...
package org.jsonk.jdk.internal;
...
public class FloatingDecimal {
    ...
    public static double parseDouble(char[] buf, int offset, int len) throws NumberFormatException {
        return readJavaFormatString(buf, offset, len).doubleValue();
    }

    public static float parseFloat(char[] buf, int offset, int len) throws NumberFormatException {
        return readJavaFormatString(buf, offset, len).floatValue();
    }
    ...
    static class ASCIIToBinaryBuffer implements ASCIIToBinaryConverter {
        ...
        ASCIIToBinaryBuffer(boolean negSign, int decExponent, char[] digits, int offset, int n)
        {
        ...
        public double doubleValue() {
            ...
            int iValue = (int) digits[offset] - (int) '0';
            int iDigits = Math.min(kDigits, INT_DECIMAL_DIGITS);
            for (int i = 1; i < iDigits; i++) {
                iValue = iValue * 10 + (int) digits[offset + i] - (int) '0';
            }
            long lValue = (long) iValue;
            for (int i = iDigits; i < kDigits; i++) {
                lValue = lValue * 10L + (long) ((int) digits[offset + i] - (int) '0');
            }
            ...
            if (nDigits > MAX_NDIGITS) {
                ...
                digits[offset + MAX_NDIGITS] = '1';
            }
            FDBigInteger bigD0 = new FDBigInteger(lValue, digits, offset, kDigits, nDigits);
        ...
        public float floatValue() {
            ...
            if (nDigits > SINGLE_MAX_NDIGITS) {
                ...
                digits[offset + SINGLE_MAX_NDIGITS] = '1';
            }
            FDBigInteger bigD0 = new FDBigInteger(iValue, digits, offset, kDigits, nDigits);
            exp = decExponent - nDigits;
    ...
    static ASCIIToBinaryConverter readJavaFormatString(char[] in, int offset, int len) throws NumberFormatException {
    ...
    parseNumber:
        ...
        digitLoop:
            ...
            return new ASCIIToBinaryBuffer(isNegative, decExp, in, offset, nDigits);
        } catch ( StringIndexOutOfBoundsException e ){ }
        throw new NumberFormatException("For input string: \"" + new String(in, offset, len) + "\"");
    }
